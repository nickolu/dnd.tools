...
- `NEXT_PUBLIC_WEB_FIREBASE_API_KEY` (preferred; legacy fallback: `NEXT_PUBLIC_FIREBASE_API_KEY`)
- `NEXT_PUBLIC_WEB_FIREBASE_AUTH_DOMAIN` (preferred; legacy fallback: `NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN`)
